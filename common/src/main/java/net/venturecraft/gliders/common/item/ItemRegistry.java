...
//    public static CreativeModeTab MAIN = CreativeModeTabRegistry.create(Component.translatable("itemGroup." + VCGliders.MOD_ID + ".main"), () -> new ItemStack(ItemRegistry.PARAGLIDER_DIAMOND.get()));
    ...
    // Gliders
    public static final RegistrySupplier<Item> PARAGLIDER_WOOD = ITEMS.register("paraglider_wood", () -> new GliderItem((new Item.Properties()).durability(50).rarity(Rarity.COMMON), new Supplier<>() {
        @Override
        public ItemStack get() {
            return new ItemStack(REINFORCED_PAPER.get());
        }
    }));
    public static final RegistrySupplier<Item> PARAGLIDER_IRON = ITEMS.register("paraglider_iron", () -> new GliderItem((new Item.Properties()).durability(100).rarity(Rarity.UNCOMMON), new Supplier<>() {
        @Override
        public ItemStack get() {
    ...
    public static final RegistrySupplier<Item> PARAGLIDER_DIAMOND = ITEMS.register("paraglider_diamond", () -> new GliderItem((new Item.Properties()).durability(300).rarity(Rarity.RARE), new Supplier<>() {
        @Override
        public ItemStack get() {
            return new ItemStack(REINFORCED_PAPER_DIAMOND.get());
        }
    }));
    public static final RegistrySupplier<Item> PARAGLIDER_NETHERITE = ITEMS.register("paraglider_netherite", () -> new GliderItem((new Item.Properties()).durability(500).rarity(Rarity.EPIC), new Supplier<>() {
        @Override
        public ItemStack get() {
